...
<div class="">
    ...
    <div class="carousel-inner">
        ...
        <div class="carousel-caption">
          ...
          <p style="font-family:arial;font-weight:600;-webkit-text-stroke: 0.5px #fff;color:#fff;">IOS Mobile App Development | Android Mobile App Development
...
<div class="container  ">
	<div class="row">	
		<div class="col-md-6 zoomInRight  wow animated " data-wow-duration="900ms" data-wow-delay="900ms">
			<img src="img/services/ios.png" class="img-responsive">
		</div>
		<div class="col-md-6 fadeInRight  wow animated " data-wow-duration="900ms" data-wow-delay="900ms">
			<h3 style="margin:5px 0px;">IOS Mobile App Development</h3>
...
<div class="container  mt-4  ">
	<div class="row">	
		...
		<div class="col-md-6 fadeInLeft wow animated " data-wow-duration="900ms" data-wow-delay="900ms">
			<h3 style="margin:5px 0px;">Android Mobile App Development</h3>
	...
	<div class="col-md-5 zoomInRight  wow animated " data-wow-duration="900ms" data-wow-delay="900ms">
			<img src="img/services/android-apps.png" class="img-responsive">
		</div>
	</div>
</div>
</section>
...
<div class="container  ">
	<div class="row">	
		<div class="col-md-6 zoomInRight  wow animated " data-wow-duration="900ms" data-wow-delay="900ms">
			<img src="img/services/hybrid-app.png" class="img-responsive">
		</div>
		<div class="col-md-6 fadeInRight  wow animated " data-wow-duration="900ms" data-wow-delay="900ms">
			<h3 style="margin:5px 0px;">Hybrid Mobile App Development</h3>
